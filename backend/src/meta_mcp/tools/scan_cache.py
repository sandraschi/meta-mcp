...
def get_cached_scan(
    scan_path: str, max_depth: int = 1, ttl: int = CACHE_TTL
...
def get_cached_repo_status(
    repo_path: str, ttl: int = CACHE_TTL
) -> Optional[Dict[str, Any]]:
...
def clear_cache(
    scan_path: Optional[str] = None, repo_path: Optional[str] = None
) -> int:
    """Clear cache entries.

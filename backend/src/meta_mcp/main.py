...
def create_fastapi_app():
    ...
    # Script is at backend/src/meta_mcp/main.py, so we need to go up 4 levels
    script_dir = os.path.dirname(__file__)  # meta_mcp
    backend_src = os.path.dirname(script_dir)  # src
    backend_dir = os.path.dirname(backend_src)  # backend
